...
import {
  PickersTextField
} from "./chunk-LVTMNHF3.js";
import {
  LocalizationProvider,
  MuiPickersAdapterContext
} from "./chunk-NFGCPQ77.js";
import {
  Button_default,
  Chip_default,
...
import {
  ...
  TextField_default,
  Typography_default
} from "./chunk-2HRZIHSH.js";
import {
  resolveComponentProps,
  useSlotProps
} from "./chunk-S5PGWZBF.js";
import "./chunk-DVCXQ4HW.js";
import "./chunk-XZN44644.js";
import {
  ButtonBase_default,
  IconButton_default
} from "./chunk-HNVIW3SQ.js";
import {
  CSSTransition_default,
  TransitionGroup_default
} from "./chunk-T3HYLK72.js";
import "./chunk-FC6PBJOI.js";
import {
  Paper_default
} from "./chunk-RB7OIVSM.js";
import {
  useTheme
} from "./chunk-PFZGCC6F.js";
import {
  alpha,
  useMediaQuery,
  useRtl
} from "./chunk-CI4NVJDY.js";
import "./chunk-TVOPUOW3.js";
import {
  init_utils as init_utils2
} from "./chunk-WWF33NAG.js";
import "./chunk-B23SWVR6.js";
import {
  createSvgIcon
} from "./chunk-MNY6BGW5.js";
import "./chunk-I6BV4G2V.js";
import "./chunk-QOCPE7UI.js";
import "./chunk-UNAVATDJ.js";
import {
  styled_default
} from "./chunk-YL7E6SVT.js";
import {
  init_useControlled,
...
} from "./chunk-H6FUW74I.js";
import {
  require_prop_types
} from "./chunk-MZAQWBUC.js";
import {
  _extends,
  init_extends
} from "./chunk-NQPST2ZO.js";
import {
  require_jsx_runtime
} from "./chunk-TUSQUPKB.js";
import {
  require_react
} from "./chunk-HGXV7WDA.js";
import {
  __toESM
} from "./chunk-ZSRNYESD.js";
...
var DateField = React25.forwardRef(function DateField2(inProps, inRef) {
  const themeProps = useThemeProps({
    props: inProps,
    name: "MuiDateField"
  });
...
var useIsDateDisabled = ({
  ...
  const adapter = useLocalizationContext();
  return React26.useCallback((day) => validateDate({
    adapter,
    value: day,
    props: {
      shouldDisableDate,
...
var useCalendarState = (params) => {
  ...
  const utils = useUtils();
  const reducerFn = React27.useRef(createCalendarStateReducer(Boolean(reduceAnimations), disableSwitchToMonthOnDayFocus, utils)).current;
  ...
  const [calendarState, dispatch] = React27.useReducer(reducerFn, {
    isMonthSwitchingAnimating: false,
    focusedDay: referenceDate,
    currentMonth: utils.startOfMonth(referenceDate),
    slideDirection: "left"
  });
  const handleChangeMonth = React27.useCallback((payload) => {
    dispatch(_extends({
      type: "changeMonth"
    }, payload));
    if (onMonthChange) {
  ...
  const changeMonth = React27.useCallback((newDate) => {
  ...
  const onMonthSwitchingAnimationEnd = React27.useCallback(() => {
    dispatch({
...
var PickersMonth = React32.memo(function PickersMonth2(inProps) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersMonth"
  });
...
var MonthCalendar = React33.forwardRef(function MonthCalendar2(inProps, ref) {
  ...
  const todayMonth = React33.useMemo(() => utils.getMonth(now), [utils, now]);
  const selectedMonth = React33.useMemo(() => {
    if (value != null) {
      return utils.getMonth(value);
    }
    return null;
  }, [value, utils]);
  const [focusedMonth, setFocusedMonth] = React33.useState(() => selectedMonth || utils.getMonth(referenceDate));
  const [internalHasFocus, setInternalHasFocus] = useControlled({
    name: "MonthCalendar",
    state: "hasFocus",
    controlled: hasFocus,
  ...
  const isMonthDisabled = React33.useCallback((dateToValidate) => {
...
var PickersYear = React34.memo(function PickersYear2(inProps) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersYear"
  });
...
var _excluded18 = ["autoFocus", "className", "value", "defaultValue", "referenceDate", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onChange", "readOnly", "shouldDisableYear", "disableHighlightToday", "onYearFocus", "hasFocus", "onFocusedViewChange", "yearsPerRow", "timezone", "gridLabelId", "slots", "slotProps"];
...
var YearCalendar = React35.forwardRef(function YearCalendar2(inProps, ref) {
  ...
  const todayYear = React35.useMemo(() => utils.getYear(now), [utils, now]);
  const selectedYear = React35.useMemo(() => {
    if (value != null) {
      return utils.getYear(value);
    }
    return null;
  }, [value, utils]);
  const [focusedYear, setFocusedYear] = React35.useState(() => selectedYear || utils.getYear(referenceDate));
  const [internalHasFocus, setInternalHasFocus] = useControlled({
    name: "YearCalendar",
    state: "hasFocus",
    controlled: hasFocus,
  ...
  const isYearDisabled = React35.useCallback((dateToValidate) => {
...
var _excluded19 = ["children", "className", "slots", "slotProps", "isNextDisabled", "isNextHidden", "onGoToNext", "nextLabel", "isPreviousDisabled", "isPreviousHidden", "onGoToPrevious", "previousLabel"];
...
var PickersArrowSwitcher = React36.forwardRef(function PickersArrowSwitcher2(inProps, ref) {
  const isRtl = useRtl();
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersArrowSwitcher"
